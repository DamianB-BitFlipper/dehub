...
import (
	...
	"github.com/dlvhdr/gh-dash/v4/internal/enhance/parser"
	"github.com/dlvhdr/gh-dash/v4/internal/enhance/tui/art"
	"github.com/dlvhdr/gh-dash/v4/internal/enhance/tui/scrollbar"
	"github.com/dlvhdr/gh-dash/v4/internal/enhance/tui/util"
	"github.com/dlvhdr/gh-dash/v4/internal/enhance/utils"
)
...
func (m Model) EmbeddedView() string {
	...
	return lipgloss.NewStyle().Width(m.width).MaxWidth(m.width).Render(content)
}
