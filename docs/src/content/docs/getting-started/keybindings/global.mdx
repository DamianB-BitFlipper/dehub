...
## `Ctrl+Shift+←/→` - Switch View

Press <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>→</kbd> to switch to the next dashboard view, or
<kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>←</kbd> to switch to the previous dashboard view. The first
time you switch to a view in your dashboard, the dashboard runs the defined query for every section
in that view.
